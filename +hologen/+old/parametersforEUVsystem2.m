...
phs(mask~=1)=NaN;
phs=DelTilt(phs);
figure(3),imagesc(x(1,:)*1665/2.5,y(:,1)*1665/2.5,phs);axis tight equal;colorbar;
...
ph4=DelTilt(ph4);
ph4=DelTilt(ph4);
figure(4),imagesc(x(1,:)*1665/2.5,y(:,1)*1665/2.5,-ph4);axis tight equal;colorbar;
